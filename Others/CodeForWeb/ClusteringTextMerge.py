...
def TextMerge(path_In_CSV, path_In_AllPic, path_Out):
...
path_Out = "G:/浙大实习/text聚类/"

output = TextMerge(path_In_CSV, path_In_AllPic, path_Out)
x = 1
