...
def ReadData(path_In_Source, path_In_Text, path_In_Product, path_In_AllPicture):
...
def ClusterOne(path_In_Source, path_In_Text, path_In_Product, path_In_AllPicture, path_Out_Product, path_Out_Text):
    TotalData = ReadData(path_In_Source, path_In_Text, path_In_Product, path_In_AllPicture)
    data = TotalData[0]
    output = []
    outputP = []
    outputT = []
...
path_In_Source = "G:/浙大实习/text_product聚类/SelectedPictureOne.txt"
...
path_Out_Product = "G:/浙大实习/text_product聚类/One2OneProduct.txt"
path_Out_Text = "G:/浙大实习/text_product聚类/One2OneText.txt"

output = ClusterOne(path_In_Source, path_In_Text, path_In_Product, path_In_AllPicture, path_Out_Product, path_Out_Text)
x = 1
