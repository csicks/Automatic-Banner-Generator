...
def ReadData():
    pathSource = "G:/浙大实习/text_product聚类/SelectedPictureTwo.txt"
    pathText = "G:/浙大实习/text聚类/"
    pathProduct = "G:/浙大实习/text_product聚类/productCorner.txt"
    pathPicture = "G:/浙大实习/聚类结果/"
    pathClass = "G:/浙大实习/text_product聚类/resultOne2TwoAngleClass.txt"
...
for ccData in data:
    ...
    for each in ccData:
        ...
        # if abs(ProductPosition[cNum][0] - pY) <= th and abs(ProductPosition[cNum][1] - pX) <= th:
...
# 文字大小聚类2
path = "G:/浙大实习/text_product聚类/One2TwoText.txt"
f3 = open(path, 'w')
kT = 0
for ttData in NewData:
    tpData = []
